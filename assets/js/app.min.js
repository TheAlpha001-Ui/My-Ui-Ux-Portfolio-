...
var cards = [
  {
    ...
    html: `
      <div class="profile-image">
        <img src="./images/selfie.jpg" alt="Abdulraqib Omotosho">
      </div>
      <div class="profile-info">
        <table>
          <tbody>
            <tr><td>Name</td><td>Abdulraqib Omotosho</td></tr>
            <tr><td>Profession</td><td>Data Scientist</td></tr>
            <tr><td>Sex</td><td>Male</td></tr>
            <tr>
            <td>Resume</td>
            <td>
              <a href="https://drive.google.com/file/d/13LKU009PnfhNQlc4qVzLw-U2YCqlJQ0B/view" target="_blank">
                <img src="https://img.icons8.com/material-outlined/24/000000/download--v1.png" alt="Download Resume Icon">
                Download Resume
              </a>
            </td>
          </tr>
            ...
            <tr>
              ...
              <td>
                ${createSocialLinks([
                  { href: "mailto:abdulraqibshakir03@gmail.com", iconClass: "fas fa-envelope" },
                  { href: "https://www.linkedin.com/in/abdulraqib-omotosho", iconClass: "fab fa-linkedin-in" },
                  { href: "https://x.com/raqibcodes", iconClass: "fab fa-twitter" },
                  { href: "https://github.com/Abdulraqib20", iconClass: "fab fa-github", target: "_blank" }
                ])}
              </td>
            </tr>
          </tbody>
  ...
  },
  {
    ...
    width: 500,
    html: `
      <div class="face-capture-image">
        <img src="./images/dp_.jpg" alt="Abdulraqib Omotosho Facial Recognition">
        <div class="face-capture-square"></div>
      </div>
      <div class="profile-info">
        <table>
          <tbody>
            <tr><td>Winner</td><td>Summer Hack 1.0 Hackathon</td></tr>
            <tr><td>Top 16</td><td>WIEHack 5.0 Hackathon</td></tr>
          </tbody>
        </table>
      </div>
    `,
  },
  {
    ...
    html: `
      <div class="finland-map-wrap">
        <img class="finland-map" src="./images/finland-map.svg" alt="Finland Map">
  ...
  },
  {
    ...
    html: `
      <table>
        <tbody>
          <tr><td>HOBBIES</td><td>Watching research documentaries on AI</td><td>Playing Games</td></tr>
        </tbody>
      </table>
    `,
  },
  ...
  },
  {
    ...
    html: `
      <table>
        <tbody>
          <tr><td width="50%">Python</td><td>Python</td></tr>
          <tr><td width="50%">Java</td><td>Java</td></tr>
          <tr><td width="50%">C++</td><td>C++</td></tr>
        </tbody>
      </table>
    `,
  },
  {
    ...
    width: 480,
    html: `<ul>
        <li>⚪ <strong>Programming Languages:</strong> Python, SQL, Java (familiar)</li>
        <li>⚪ <strong>Machine Learning & AI:</strong> Supervised, Unsupervised learning, Gradient Boosting Trees Algorithms, Natural Language Processing, Neural Networks, Generative AI & LLMs</li>
        <li>⚪ <strong>Data Analysis & Visualization:</strong> Pandas, NumPy, Matplotlib, Seaborn, Scikit-learn, Plotly, Altair</li>
        <li>⚪ <strong>NLP & Deep Learning Frameworks:</strong> NLTK, Keras, TensorFlow, PyTorch</li>
        <li>⚪ <strong>Version Control:</strong> Git, GitHub</li>
        <li>⚪ <strong>Database Management:</strong> MySQL, PostgreSQL, MSSQL, BigQuery</li>
        <li>⚪ <strong>Developer Tools:</strong> Pycharm, VS-Code, Jupyter, Colab, Scripting, MS Office (PowerPoint, Word, Excel), Canva, Figma</li>
        <li>⚪ <strong>Soft Skills:</strong> Communication, Teamwork, Leadership, Report Writing, Problem-solving</li>
      </ul>`,
  },
  {
    title: "Audio Feed",
...
/**
 * Create social links HTML string
...
/**
 * Render cards to the specified container
...
// Example: Call renderCards with the ID of the container where you want to display the cards
...
if (window.location.pathname === "/") {
  new Terminal({
    ...
    commands: [
      {
        text: 'load profile -firstName "Ashu" -lastName "Jha"',
        typing: true,
      },
      {
        text: "loading...",
